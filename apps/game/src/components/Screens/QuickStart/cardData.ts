...
export const cardFeatures: Omit<CardFeatureProps, 'className'>[] = [
  {
    ...
    cardImgSrc: common1,
    cardDesc: "Don't look now, but we've got company. Adds 1 point to play.",
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common2,
    cardDesc: "Now you see me...actually no, you don't see me. Adds 2 points to play.",
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common3,
    cardDesc: 'That "free" coffeeshop WiFi wasn\'t free. Adds 3 points to play.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common4,
    cardDesc: 'Who knew an address made you easy to find? Adds 4 points to play.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common5,
    cardDesc: 'This is how you get ants. (And trackers.) Adds 5 points to play.',
  },
  {
  ...
  },
  {
    ...
    cardImgSrc: blocker1,
    cardDesc: 'Subtract from opponent\'s turn value by 1. Play again.',
  },
  {
    cardTotalNumber: '2 cards',
    cardType: 'Blocker:',
    ...
    cardImgSrc: blocker2,
    cardDesc: 'Subtract from opponent\'s turn value by 2. Play again.',
  },
  {
