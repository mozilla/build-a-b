...
export const cardFeatures: Omit<CardFeatureProps, 'className'>[] = [
  {
    ...
    cardImgSrc: common1,
    cardDesc: 'Adds 1 point to turn value.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common2,
    cardDesc: 'Adds 2 points to turn value.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common3,
    cardDesc: 'Adds 3 points to turn value.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common4,
    cardDesc: 'Adds 4 points to turn value.',
  },
  {
    cardTotalNumber: '8 cards',
    cardType: 'Common Data:',
    ...
    cardImgSrc: common5,
    cardDesc: 'Adds 5 points to turn value.',
  },
  {
    ...
    cardImgSrc: tracker1,
    cardDesc: 'Boosts your turn value by 1.',
  },
  {
    cardTotalNumber: '2 cards',
    cardType: 'Tracker:',
    ...
    cardImgSrc: tracker2,
    cardDesc: 'Boosts your turn value by 2.',
  },
  {
    cardTotalNumber: '2 cards',
    cardType: 'Tracker:',
    ...
    cardImgSrc: tracker3,
    cardDesc: 'Boosts your turn value by 3.',
  },
  {
    cardTotalNumber: '2 cards',
    cardType: 'Blocker:',
    ...
    cardImgSrc: blocker1,
    cardDesc: 'Subtract from opponents turn value by 1.',
  },
  {
    cardTotalNumber: '2 cards',
    cardType: 'Blocker:',
    ...
    cardImgSrc: blocker2,
    cardDesc: 'Subtract from opponents turn value by 2.',
  },
  {
