...
interface DrawerProps {
  isOpen: boolean;
  billionaire: BillionaireOption | null;
  onClose: () => void;
  onConfirm: () => void;
}
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Drawer Content */}
            <div className="relative w-full bg-[#0a0a15] rounded-tl-[32px] sm:rounded-tl-[40px] rounded-tr-[32px] sm:rounded-tr-[40px] overflow-hidden pb-6 sm:pb-8">
              <img
                src={nightSkyBg}
                alt=""
              ...
              />
              {/* Inner glow effect */}
              <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_8px_30px_0px_rgba(0,166,249,0.5)]" />
              ...
              <div className="relative flex flex-col items-center gap-3 sm:gap-4 md:gap-6 pt-12 sm:pt-16 md:pt-20 px-4 sm:px-6 md:px-8 max-h-[90vh] overflow-y-auto">
                {/* Billionaire Image */}
                <div className="relative w-[140px] h-[140px] sm:w-[160px] sm:h-[160px] md:w-[195px] md:h-[195px] flex-shrink-0">
                  <img
                ...
                <div className="w-full max-w-[326px] mx-auto">
                  ...
                  <div className="bg-gradient-to-r from-[#00a6f9] to-[#754fe0] rounded-t-[9px] px-2 sm:px-3 py-1.5 sm:py-2 border border-[#00a6f9]">
                  ...
                  {/* Card Content */}
                  <div className="bg-common-ash rounded-b-[9px] px-3 sm:px-4 py-2.5 sm:py-3 md:py-4 border-b-2 border-l-2 border-r-2 border-[#00a6f9]">
                    <Text
                ...
                <div className="mt-2 sm:mt-3 md:mt-4 w-full px-2 sm:px-4">
                  <Button
                    onClick={onConfirm}
                    variant="primary"
                    className="w-full max-w-[248px] mx-auto block"
                  >
                    Select
                  </Button>
                </div>
