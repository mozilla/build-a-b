...
export const DATA_GRAB_CONFIG = {
  ...
  CARD_FALL_DURATION_MS: 2500, // Base time for card to traverse from top to bottom
  CARD_SPEED_VARIATION_PERCENT: 40, // Speed variation as integer percent (20 = ±20%)
  INITIAL_CARD_DELAY_MS: 500, // Delay before first card starts falling
  CARD_DELAY_INCREMENT_MIN_MS: 150, // Minimum delay between card starts
  CARD_DELAY_INCREMENT_MAX_MS: 500, // Maximum delay between card starts
