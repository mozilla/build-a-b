...
describe('buildImageUrl', () => {
  ...
  it('replaces /object/ with /render/image/ and adds default dimensions', () => {
    ...
    const expected = `/render/image/avatar.jpg?width=${DEFAULT_AVATAR_WIDTH}&height=${DEFAULT_AVATAR_HEIGHT}&resize=cover&quality=80`;
  ...
  it('uses custom width and height when provided', () => {
    ...
    const width = 300;
    const height = 400;
    const expected = '/render/image/avatar.jpg?width=300&height=400&resize=cover&quality=80';
  ...
  it('handles filePaths without /object/ prefix', () => {
    ...
    const expected = `/some/other/path/image.png?width=${DEFAULT_AVATAR_WIDTH}&height=${DEFAULT_AVATAR_HEIGHT}&resize=cover&quality=80`;
  ...
  it('handles multiple /object/ occurrences by replacing only the first', () => {
    ...
    const expected = `/render/image/folder/object/image.jpg?width=${DEFAULT_AVATAR_WIDTH}&height=${DEFAULT_AVATAR_HEIGHT}&resize=cover&quality=80`;
