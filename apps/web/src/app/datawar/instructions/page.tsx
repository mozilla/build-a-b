...
export default async function Page() {
  ...
  const [isPhase2B, isDataWarEnabled, isPhase2C, isPhase4] = await Promise.all([
  ...
  return (
    <>
          ...
          <Bento className="border-none h-full landscape:flex-1 landscape:h-auto">
            <Window className="bg-common-ash">
              <div className="p-4 landscape:p-12 flex flex-col gap-4">
                <h2 className="text-title-1 text-charcoal">Play Data War Digital for free!</h2>
                <p className="text-body-regular text-charcoal">
                  At TwitchCon, we launched Data War, the physical edition. Now, we’re dropping Data
                  War Digital, a cozy, chaotic, browser-first experience that’s free for everyone to
                  play, available now.
                </p>
                <div className="flex gap-4 portrait:flex-col portrait:w-full landscape:w-auto">
                  ...
                  >
                    ...
                    <span className="font-semibold text-lg leading-6">Play Data War Digital</span>
                  </LinkButton>
                </div>
              </div>
            </Window>
      ...
      <FullInstructions isPhase4={isPhase4} />
