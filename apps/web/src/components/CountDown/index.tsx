  ...
  return (
    <section className={clsx('mb-4 landscape:mb-8', className)}>
      <Bento image="/assets/images/space.webp">
        <div
          className="relative p-4 landscape:px-20 landscape:py-16 bg-gradient-to-r from-black to-transparent
                     flex flex-col landscape:flex-row gap-12 justify-center items-center"
        >
          <div className="flex flex-col gap-4 items-start">
            ...
            <p className="text-body-regular text-[1.125rem]">
            ...
            {cta && <div className="hidden landscape:block">{cta}</div>}
          </div>
          <RocketCountdown isPhase2B={isPhase2B} isPhase2C={isPhase2C} isPhase4={isPhase4} />
          {cta && <div className="landscape:hidden w-full">{cta}</div>}
        </div>
      </Bento>
    </section>
  );
